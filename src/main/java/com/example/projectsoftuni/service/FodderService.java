...
public interface FodderService {
    ...
    List<Fodder> getKgOfFodderBySilo(SearchFromToKgAcceptedFooderServiceModel searchFromToKgAcceptedFooderServiceModel);

    Long checkStatusKg();

    Long getKgOfFodderBySiloLast(CategorySiloEnum siloEnum);
